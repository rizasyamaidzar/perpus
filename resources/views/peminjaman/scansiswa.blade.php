...
@section('content')
<div class="m-10">
    <h1 class="text-center">Form Scan Siswa</h1>
    <form method="POST" action="{{ route('peminjaman.store')}}"  enctype="multipart/form-data" class="p-4 md:p-5">
        @csrf         
       
        <div id="reader" width="600px"></div>
        <input type="hidden" name="buku_id" id="buku_id" value="{{ $buku }}">
        <input type="hidden" name="siswa_id" id="hiddenInput" value="hiddenInput">
